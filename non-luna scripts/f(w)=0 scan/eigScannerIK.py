...
class Solver(object):
    def __init__(self):
        ...
        #self.eigs = {'w':np.logspace(-4,-2,3)} # problem with logspace: lower resolution for higher numbers
        self.eigs = {'w':np.linspace(1E-4,1E-2,20)}
    ...
    def _runVENUS(self, w, idx = 0, labelnr = 0):
     ...
     #Read equilibrium from VMEC output file and transform it into SFL
        ...
        stab.grid.N = 100 #eq.R.shape[1]-2
